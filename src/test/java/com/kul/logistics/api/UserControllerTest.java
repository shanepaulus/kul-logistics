...
public class UserControllerTest {
	...
	public void testUserLogin_ok() throws Exception {
		...
		UsernamePasswordAuthenticationToken userAuth = new UsernamePasswordAuthenticationToken(USER_EMAIL, USER_PASSWORD,
				Collections.emptyList());

		when(authenticationManager.authenticate(any(UsernamePasswordAuthenticationToken.class))).thenReturn(userAuth);
